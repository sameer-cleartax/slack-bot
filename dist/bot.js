...
console.log('payload', github.context.payload.pull_request != null && github.context.payload.pull_request.pull_request._links.comments);
console.log('payload', github.context.payload.pull_request != null && github.context.payload.pull_request.pull_request._links.commits);
